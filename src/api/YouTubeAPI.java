...
public class YouTubeAPI {
    ...
    /**
     * List of YouTube categories. Need to be fetched if necessary, as they may
     * change over time
     */
    private Collection<YouTubeCategory> youtubeCategories;

    /**
     * Constructor requires YouTube v3 API key which can be requested at
    ...
    protected Collection<YouTubePlaylistItems> getPlayListItems(String id) throws Exception {
        ...
        do {
            ...
            /**
             * maxResults is set because default value for results per page are
             * only 5 Reduces number of calls to fetch large playlists
             */
            try {
    ...
    public YouTubeCategory getCategoryById(String id) throws Exception {
        // Only fetch categories from API if the current API instance has not
        // fetched them yet
